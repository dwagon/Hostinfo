...
class Command(HostinfoCommand):
    ...
    def parseArgs(self, parser):
        parser.add_argument('--showall',help='Print everything known about the matching hosts', action='store_true')
        parser.add_argument('--origin',help='Print out origin of data', action='store_true')
        parser.add_argument('--aliases',help='Print out all aliases of matching host', action='store_true')
        parser.add_argument('--times','--dates',help='Print out create and modification times of data', dest='times', action='store_true')
        parser.add_argument('--noheader',help="Don't print headers in CSV format", dest='header', action='store_false', default=True)
        ...
        parser.add_argument('-p',help="Print values of key for matching hosts", action='append', dest='printout', default=[])

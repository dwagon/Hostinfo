...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.send_create_signal("host", ["HostAudit"])
        ...
        db.send_create_signal("host", ["Host"])

        # Adding model 'HostAliasAudit'
        db.create_table(
            "host_hostalias_audit",
            (
                (
                    "hostid",
        ...
        db.send_create_signal("host", ["HostAliasAudit"])
        ...
        db.send_create_signal("host", ["HostAlias"])

        # Adding model 'AllowedKeyAudit'
        db.create_table(
            "host_allowedkey_audit",
            (
        ...
        db.send_create_signal("host", ["AllowedKeyAudit"])
        ...
        db.send_create_signal("host", ["AllowedKey"])
        ...
        db.send_create_signal("host", ["KeyValueAudit"])
        ...
        db.send_create_signal("host", ["KeyValue"])

        # Adding unique constraint on 'KeyValue', fields ['hostid', 'keyid', 'value']
        db.create_unique("host_keyvalue", ["hostid_id", "keyid_id", "value"])
        ...
        db.send_create_signal("host", ["UndoLog"])

        # Adding model 'RestrictedValueAudit'
        db.create_table(
            "host_restrictedvalue_audit",
            (
                (
                    "keyid",
                    self.gf("django.db.models.fields.related.ForeignKey")(
        ...
        db.send_create_signal("host", ["RestrictedValueAudit"])

        # Adding model 'RestrictedValue'
        db.create_table(
            "host_restrictedvalue",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
                (
                    "keyid",
        ...
        db.send_create_signal("host", ["RestrictedValue"])

        # Adding unique constraint on 'RestrictedValue', fields ['keyid', 'value']
        db.create_unique("host_restrictedvalue", ["keyid_id", "value"])
        ...
        db.send_create_signal("host", ["LinksAudit"])
        ...
        db.send_create_signal("host", ["Links"])

    def backwards(self, orm):
        # Removing unique constraint on 'RestrictedValue', fields ['keyid', 'value']
        db.delete_unique("host_restrictedvalue", ["keyid_id", "value"])

        # Removing unique constraint on 'KeyValue', fields ['hostid', 'keyid', 'value']
        db.delete_unique("host_keyvalue", ["hostid_id", "keyid_id", "value"])

        # Deleting model 'HostAudit'
        db.delete_table("host_host_audit")

        # Deleting model 'Host'
        db.delete_table("host_host")

        # Deleting model 'HostAliasAudit'
        db.delete_table("host_hostalias_audit")

        # Deleting model 'HostAlias'
        db.delete_table("host_hostalias")

        # Deleting model 'AllowedKeyAudit'
        db.delete_table("host_allowedkey_audit")

        # Deleting model 'AllowedKey'
        db.delete_table("host_allowedkey")

        # Deleting model 'KeyValueAudit'
        db.delete_table("host_keyvalue_audit")

        # Deleting model 'KeyValue'
        db.delete_table("host_keyvalue")

        # Deleting model 'UndoLog'
        db.delete_table("host_undolog")

        # Deleting model 'RestrictedValueAudit'
        db.delete_table("host_restrictedvalue_audit")

        # Deleting model 'RestrictedValue'
        db.delete_table("host_restrictedvalue")

        # Deleting model 'LinksAudit'
        db.delete_table("host_links_audit")

        # Deleting model 'Links'
        db.delete_table("host_links")
    ...
    models = {
        ...
        "host.allowedkeyaudit": {
            "Meta": {
                "ordering": "['-_audit_timestamp']",
                "object_name": "AllowedKeyAudit",
                "db_table": "u'host_allowedkey_audit'",
            },
            "_audit_change_type": (
                "django.db.models.fields.CharField",
                [],
        ...
        "host.hostaliasaudit": {
            "Meta": {
                "ordering": "['-_audit_timestamp']",
                "object_name": "HostAliasAudit",
                "db_table": "u'host_hostalias_audit'",
            },
            "_audit_change_type": (
                "django.db.models.fields.CharField",
                [],
        ...
        "host.hostaudit": {
            "Meta": {
                "ordering": "['-_audit_timestamp']",
                "object_name": "HostAudit",
                "db_table": "u'host_host_audit'",
            },
            "_audit_change_type": (
                "django.db.models.fields.CharField",
                [],
        ...
        "host.keyvalueaudit": {
            "Meta": {
                "ordering": "['-_audit_timestamp']",
                "object_name": "KeyValueAudit",
                "db_table": "u'host_keyvalue_audit'",
            },
            "_audit_change_type": (
                "django.db.models.fields.CharField",
                [],
        ...
        "host.linksaudit": {
            "Meta": {
                "ordering": "['-_audit_timestamp']",
                "object_name": "LinksAudit",
                "db_table": "u'host_links_audit'",
            },
            "_audit_change_type": (
                "django.db.models.fields.CharField",
                [],
        ...
        "host.restrictedvalue": {
            "Meta": {
                "unique_together": "(('keyid', 'value'),)",
                "object_name": "RestrictedValue",
            },
            "createdate": (
                "django.db.models.fields.DateField",
                [],
        ...
        "host.restrictedvalueaudit": {
            "Meta": {
                "ordering": "['-_audit_timestamp']",
                "object_name": "RestrictedValueAudit",
                "db_table": "u'host_restrictedvalue_audit'",
            },
            "_audit_change_type": (
                "django.db.models.fields.CharField",
                [],

...
class test_getMatches(TestCase):
    ...
    ###########################################################################
    def test_leneq(self):
        self.assertEquals(getMatches([("leneq", "list", "2")]), [self.host.id])

    ###########################################################################
    def test_lengt(self):
        self.assertEquals(getMatches([("lengt", "list", "3")]), [])
    ...
    def test_equals(self):
        ...
        self.assertEquals(getMatches([("equal", "number", "2.0")]), [self.host2.id])
        try:
    ...
    def test_greaterthan(self):
        ...
        self.assertEquals(getMatches([("greaterthan", "number", "10")]), [self.host.id])
        try:
    ...
    def test_lessthan(self):
        ...
        self.assertEquals(getMatches([("lessthan", "date", "2012-12-24")]), [])
        self.assertEquals(
            getMatches([("lessthan", "date", "2012-12-26")]), [self.host.id]
        )
        self.assertEquals(getMatches([("lessthan", "number", "90")]), [self.host2.id])
        try:
        ...
        self.assertEquals(
            sorted(
                [
                    ...
                    if "django/forms/widgets" not in t.name
                ]
            ),
...
class test_hostviewrepr(TestCase):
    ...
    def test_view(self):
        ...
        self.assertEquals(ans, [("hvrkey1", [self.kv1]), ("hvrkey2", [self.kv2])])
    ...
    def test_printers(self):
        ...
        self.assertEquals(ans, [("hvrkey1", [self.kv1])])
    ...
    def test_printer_with_missing(self):
        ...
        self.assertEquals(ans, [("hvrkey2", []), ("hvrkey1", [kv])])
        kv.delete()
...
class test_getHostMergeKeyData(TestCase):
    ...
    def test_hmkd(self):
        ...
        self.assertEquals(sorted(k[1][1]["src"]), sorted(["alpha", "beta"]))
...
class test_calcKeylistVals(TestCase):
    ...
    def test_conditional(self):
        ...
        self.assertEquals(d["vallist"], [("baz", 1, 100.0)])
    ...
    def test_another_key(self):
        ...
        self.assertEquals(d["numvals"], 1)
        self.assertEquals(d["vallist"], [("foo", 1, 100.0)])
    ...
    def test_simple_key(self):
        ...
        self.assertEquals(d["vallist"], [("bar", 1, 50.0), ("baz", 1, 50.0)])
...
class test_hostData(TestCase):
    ...
    def test_printers(self):
        ...
        self.assertEquals(result["user"], "fred")
        self.assertEquals(result["hostlist"][0]["hostview"], [("hdfkey2", [self.kv2])])
        self.assertEquals(result["hostlist"][1]["hostview"], [("hdfkey2", [self.kv3])])
